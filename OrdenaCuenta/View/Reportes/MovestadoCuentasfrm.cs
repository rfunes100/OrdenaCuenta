...
namespace OrdenaCuenta.View.Reportes
{
    public partial class MovestadoCuentasfrm : MaterialForm
    {
        ...
        private void btagregar_Click(object sender, EventArgs e)
        {
            ...
            this.expexcel.ExportarDataTableAExcel(resultado, "C:\\Users\\rfune3\\OneDrive - Fruit of the Loom\\Desktop\\ordenacuenta\\estadocuentaproveedor\\" + txtruta.Text + ".xlsx", "ESTADO De Resultados");
