...
{
    public partial class PagaClientefrm : MaterialForm
    {
        ...
        private void cargar()
        {
            ...
            MaterialListView materialListView = clicon.GetClienteBuscador(); // clacuenta.GetClasificacionCuenta();
        ...
        private void PagaClientefrm_Load(object sender, EventArgs e)
        {
        ...
        private void btnagregar_Click(object sender, EventArgs e)
        {
            ...
            idsubcuenta = clicon.getclientesubcue( Convert.ToInt32(this.id));
            ...
            monedaModel.Id = Convert.ToInt32(idcuenta);
            ...
            if (TipoMonedalocal != "HNL")
            {
                ...
                HistoricoMonedaModel.Id = idcuenta /*cmbcuenta.SelectedValue.ToString()*/ ;
                HistoricoMonedaModel.estado = "pagacliente";
            ...
            partidamod.Debe = (int)Math.Round(Convert.ToDecimal(montoconvertido)); // Convert.ToInt32(txtmonto.Text);
            partidamod.Haber = 0 ;
            ...
            partidamod.TipoTransaccion = "PartidasCliente"; 
            partidamod.estado = "partclientesdebe";
            ...
            partidamod.CuentaPar = idcuenta;// Convert.ToInt32(item.SubItems[6].Text);
                partidamod.Parcial = 0;
                partidamod.Debe =0 ;
            partidamod.Haber = (int)Math.Round(Convert.ToDecimal(montoconvertido)); // Convert.ToInt32(txtmonto.Text);
                partidamod.Referencia = txtdescripcion.Text;
                partidamod.ParIdEmpresa = 3;
                partidamod.ParIdLibro = Convert.ToInt32(cmblibro.SelectedValue.ToString());
                partidamod.UsuarioCreacion = usuario;
                partidamod.TipoTransaccion = "PartidasCliente";
                partidamod.estado = "partcliente";
                partidamod.subcueid = idsubcuenta;
        ...
        private void lsclientes_Click(object sender, EventArgs e)
        {
            ...
            this.Abonopar = Convert.ToDecimal( lsclientes.SelectedItems[0].SubItems[5].Text);
