...
{
    internal class rolesopcionesController
    {
        public rolesopcionesController() { }
        ...
        public MaterialListView Gettransacciones()
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("rolesopcionesshow", Con);
        ...
        public bool Crear(rolesopcionesModel Modelo)
        {
            try
            {
                using (SqlConnection Con = new Conexion().GetConexion("BDConexion"))
                {
                    ...
                    string sql = "execute rolesopcionesevento " + Modelo.ind + " , "
                        + Modelo.id + " , "
                        + Modelo.usuid + " , "
                        + Modelo.rolid + " "
