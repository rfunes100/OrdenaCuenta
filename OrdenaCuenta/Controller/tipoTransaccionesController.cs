...
{
    internal class tipoTransaccionesController
    {
        ...
        public MaterialListView Gettransacciones()
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("tipoTransaccionesshow", Con);
        ...
        public bool eliminar(tipoTransaccionesModel Modelo)
        {
            try
            {
                using (SqlConnection Con = new Conexion().GetConexion("BDConexion"))
                {
                    ...
                    string sql = "execute tipoTransaccionessdel '" + Modelo.id + "' ";
        ...
        public bool Crear(tipoTransaccionesModel Modelo)
        {
            try
            {
                using (SqlConnection Con = new Conexion().GetConexion("BDConexion"))
                {
                    ...
                    string sql = "execute tipoTransaccionesadd '" + Modelo.id + "' , '"
                        + Modelo.descripcion + "' , "
                         + Modelo.ttraidempresa + "  " 
